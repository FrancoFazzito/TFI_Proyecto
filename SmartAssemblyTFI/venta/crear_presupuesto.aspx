                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox onkeypress="return this.value.length<11" CssClass="form-control" ID="TextBox1" runat="server" TextMode="Number" step="1000" placeholder="Cantidad de dinero"></asp:TextBox>
                                </div>
